...
<div class="container py-4">
        ...
        <div class="col-12">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent p-0 mb-0">
                    ...
                    <li class="breadcrumb-item active text-dark" aria-current="page">My Returns</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <h4 class="fw-bold mb-1">🔄 My Returns</h4>
            <p class="text-muted small">View all your return requests.</p>
        </div>
    </div>
        ...
        <table class="table table-hover align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="badge bg-warning text-dark px-2 py-1 rounded-pill" style="font-size: 10px;">
                            Return Requested 🔄
                        </span>
                    </td>
                    <td>
...
@else
    ...
    <div class="text-center py-5" style="min-height: 320px;">
        <i class="fas fa-undo fa-3x text-muted mb-3 opacity-25"></i>
        <h6 class="fw-bold mb-2">No Returns</h6>
        <p class="text-muted small">You haven't requested any returns yet.</p>
