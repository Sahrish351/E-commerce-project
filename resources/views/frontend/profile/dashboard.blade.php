...
<div class="container py-4">
    ...
    <div class="row g-4">
        <!-- Sidebar - Exactly like Edit Profile page -->
        <div class="col-lg-3">
        ...
        <div class="col-lg-9">
            ...
            <div class="recent-orders p-3 rounded-3" style="background: #fff; border: 1px solid #e8e8e8;">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <a href="{{ route('profile.orders') }}" class="text-decoration-none small fw-semibold" style="color: #db4444;">
...
<style>
    ...
    /* Sidebar Links - Same as Edit Profile */
    .sidebar-link {
        color: #6c757d;
        font-size: 14px;
        transition: all 0.2s;
