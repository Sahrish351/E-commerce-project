...
@section('title', 'Edit Coupon - StyleHub Admin')
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="number" name="min_order_value" class="form-control @error('min_order_value') is-invalid @enderror" value="{{ old('min_order_value', $coupon->min_order_value ?? 0) }}" step="0.01" min="0">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="number" name="usage_limit" class="form-control @error('usage_limit') is-invalid @enderror" value="{{ old('usage_limit', $coupon->usage_limit) }}" min="1" placeholder="Leave empty for unlimited">
