...
Route::middleware('auth')->prefix('orders')->name('orders.')->group(function () {
    ...
    Route::get('/returns', [OrderController::class, 'returns'])->name('returns'); // ✅ orders.returns
    Route::get('/cancellations', [OrderController::class, 'cancellations'])->name('cancellations'); // ✅ orders.cancellations
